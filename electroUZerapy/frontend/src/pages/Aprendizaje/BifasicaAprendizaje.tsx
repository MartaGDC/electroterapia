...
import { calculateMaxAnchuraTren, formasOnda, maxAnchura, maxFrecuencia, maxFrecuenciaTrenes, maxIntensidad, minAnchura, minFrecuencia, minFrecuenciaTrenes, minIntensidad, plotSerie, stepAnchura, stepFrecuencia, stepFrecuenciaTrenes, stepIntensidad, tecnicas, tipos_fibras } from '../../classes/Bifasica';
