...
import { aplicadores_HILT, aplicadores_LLLT, dosis_total, frecuenciasPulso, longitudesOnda, modos_emision, potencias, superficie_tratada, tipos } from '../../classes/Laser';
