...
import { conductores, dutyCycles, electrodo_activo_bi, electrodo_activo_mo, electrodo_pasivo_bi, maxFrecBi, maxPotencia, minFrecBi, minPotencia, minTratamiento, modo_emision, stepFrecBi, stepPotencia, tipos } from '../../classes/Diatermia';
