...
import { dutyCycles, maxDistancia, maxFrecuencia, maxPotencia, minDistancia, minFrecuencia, minPotencia, modo_emision, modos, stepDistancia, stepFrecuencia, stepPotencia } from '../../classes/OndaCorta';
