...
import GalvanicoAprendizaje from '../pages/Simuladores/Galvanica/GalvanicaAprendizaje';
import GalvanicaSimulacion from '../pages/Simuladores/Galvanica/GalvanicaSimulacion';
import MediaFrecuenciaAprendizaje from '../pages/Simuladores/MediaFrecuencia/MediaFrecuenciaAprendizaje';
import DiatermiaAprendizaje from '../pages/Simuladores/Diatermia/DiatermiaAprendizaje';
import BifasicaAprendizaje from '../pages/Simuladores/Bifasica/BifasicaAprendizaje';
import MonofasicaAprendizaje from '../pages/Simuladores/Monofasica/MonofasicaAprendizaje';
import LaserAprendizaje from '../pages/Simuladores/Laser/LaserAprendizaje';
import OndaCortaAprendizaje from '../pages/Simuladores/OndaCorta/OndaCortaAprendizaje';
import MicroOndasAprendizaje from '../pages/Simuladores/MicroOndas/MicroOndasAprendizaje';
import InfrarrojosAprendizaje from '../pages/Simuladores/Infrarrojos/InfrarrojosAprendizaje';
import UVAprendizaje from '../pages/Simuladores/UV/UVAprendizaje';
import MagnetoterapiaAprendizaje from '../pages/Simuladores/Magnetoterapia/MagnetoterapiaAprendizaje';
import UltrasonidosAprendizaje from '../pages/Simuladores/Ultrasonidos/UltrasonidosAprendizaje';
import OndasChoqueAprendizaje from '../pages/Simuladores/OndasChoque/OndasChoqueAprendizaje';
import Ajustes from '../pages/Ajustes/Ajustes';
import { useUser } from '../context/userContext';
import MonofasicaSimulacion from '../pages/Simuladores/Monofasica/MonofasicaSimulacion';
import constants from '../constants/constants';
import BifasicaSimulacion from '../pages/Simuladores/Bifasica/BifasicaSimulacion';
import MediaFrecuenciaSimulacion from '../pages/Simuladores/MediaFrecuencia/MediaFrecuenciaSimulacion';
import DiatermiaSimulacion from '../pages/Simuladores/Diatermia/DiatermiaSimulacion';
import MicroOndasSimulacion from '../pages/Simuladores/MicroOndas/MicroOndasSimulacion';
import { Roles } from '../constants/interfaces';
import ProtectedRoute from './ProtectedRoute';
import Alumnos from '../pages/Alumnos';
import OndaCortaSimulacion from '../pages/Simuladores/OndaCorta/OndaCortaSimulacion';
import InfrarrojosSimulacion from '../pages/Simuladores/Infrarrojos/InfrarrojosSimulacion';
import UVSimulacion from '../pages/Simuladores/UV/UVSimulacion';
import MagnetoterapiaSimulacion from '../pages/Simuladores/Magnetoterapia/MagnetoterapiaSimulacion';
import UltrasonidosSimulacion from '../pages/Simuladores/Ultrasonidos/UltrasonidosSimulacion';
import OndasChoqueSimulacion from '../pages/Simuladores/OndasChoque/OndasChoqueSimulacion';
import LaserSimulacion from '../pages/Simuladores/Laser/LaserSimulacion';
