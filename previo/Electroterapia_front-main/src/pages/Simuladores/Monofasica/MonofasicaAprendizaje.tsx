...
import { anchuras, anchuras_pausa, formasOnda, maxFrecuencia, maxIntensidad, minFrecuencia, minIntensidad, minMaxAnchuras, plotSerie, stepFrecuencia, stepIntensidad, tecnicas, tipos_diadinamica } from './Monofasica';
