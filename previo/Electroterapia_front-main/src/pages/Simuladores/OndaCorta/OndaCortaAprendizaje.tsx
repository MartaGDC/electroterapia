...
import { dutyCycles, electrodos, maxDistancia, maxFrecuencia, maxPotencia, minDistancia, minFrecuencia, minPotencia, modo_emision, modos, stepDistancia, stepFrecuencia, stepPotencia } from './OndaCorta';
