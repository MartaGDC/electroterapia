...
import { intensidades, maxDistancia, maxFrecuencia, minDistancia, minFrecuencia, minIntensidad, modos_emision, stepDistancia, stepFrecuencia, tipo_frecuencia, tipos } from './Magnetoterapia';
